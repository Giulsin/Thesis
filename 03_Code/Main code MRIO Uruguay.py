# -*- coding: utf-8 -*-
"""
Created on Thu Aug 14 22:50:11 2025
...
#%% Aggregation
path_aggr = r"C:\Users\Giulia\MS_Industrial Ecology\Thesis\Scenario Analysis\Aggregations\aggregation_Uruguay.xlsx"
...
#%%Calculation Scenario 2, Uruguay: Decrease of 40% of virgin plastics, increase of 40% of recycled plastics
...
exiobase.shock_calc(
    ...
    scenario='Scenario 2',
    force_rewrite=True,
    notes=["Decrease of 40% of virgin plastics,and increase of 40% of recycled plastics"])


#%% Intervention UY: Value added by region

V_Scenario_2_UY = exiobase.query(
    matrices= 'V',
    scenarios='Scenario 2',
    ).loc[ValueAdded].sum()

V_delta_s2_UY = exiobase.query(
    matrices='V',
    scenarios='Scenario 2',
...
V_delta_s2_UY_region = V_delta_s2_UY.groupby(level= 0).sum().sort_values()
V_delta_s2_UY_tot = V_delta_s2_UY.groupby(level= 0).sum().sum()
V_delta_s2_UY_region.to_excel('V_delta_region_s2_UY.xlsx', index=True)


#%% Intervention UY: GHG by region
GHG_Scenario_2_UY = exiobase.query(
    matrices= 'E',
    scenarios='Scenario 2',
    ).loc[CO2_all].sum()

GHG_delta_s2_UY = exiobase.query(
    matrices='E',
    scenarios='Scenario 2',
    base_scenario='baseline',
    type='absolute',
...
GHG_delta_s2_UY_region = GHG_delta_s2_UY.groupby(level= 0).sum().sort_values()
GHG_delta_s2_UY_tot = GHG_delta_s2_UY.groupby(level= 0).sum().sum()
GHG_delta_s2_UY_region.to_excel('GHG_delta_region_s2_UY.xlsx', index=True)

#%% Intervention UY:employment by region
emp_Scenario_2_UY= exiobase.query(
    matrices='E',
    scenarios='Scenario 2',
    ).loc[Employment_people].sum()

emp_delta_s2_UY = exiobase.query(
    matrices='E',
    scenarios='Scenario 2',
    base_scenario='baseline',
    type='absolute',
...
emp_delta_s2_UY_region = emp_delta_s2_UY.groupby(level= 0).sum().sort_values()
emp_delta_s2_UY_tot = emp_delta_s2_UY.groupby(level= 0).sum().sum()
emp_delta_s2_UY_region.to_excel('emp_delta_region_s2_UY.xlsx', index=True)
#%% Intervention UY: Nutrients by region
Nutrients_Scenario_2_UY = exiobase.query(
    matrices= 'E',
    scenarios='Scenario 2',
    ).loc[Nutrients].sum()

Nutrients_delta_s2_UY = exiobase.query(
    matrices='E',
    scenarios='Scenario 2',
    base_scenario='baseline',
    type='absolute',
...
Nutrients_delta_s2_UY_region = Nutrients_delta_s2_UY.groupby(level= 0).sum().sort_values()
Nutrients_delta_s2_UY_tot = Nutrients_delta_s2_UY.groupby(level= 0).sum().sum()
Nutrients_delta_s2_UY_region.to_excel('Nutrients_delta_region_s2_UY.xlsx', index=True)

#%%Intervention UY: Land use by region

Land_use_Scenario_2_UY = exiobase.query(
    matrices= 'E',
    scenarios='Scenario 2',
    ).loc[Land_use].sum()

Land_use_delta_s2_UY = exiobase.query(
    matrices='E',
    scenarios='Scenario 2',
    base_scenario='baseline',
    type='absolute',
...
Land_use_delta_s2_UY_region = Land_use_delta_s2_UY.groupby(level= 0).sum().sort_values()
Land_use_delta_s2_UY_tot = Land_use_delta_s2_UY.groupby(level= 0).sum().sum()
Land_use_delta_s2_UY_region.to_excel('Land_use_delta_region_s2_UY.xlsx', index=True)
